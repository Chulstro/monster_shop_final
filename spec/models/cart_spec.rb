...
RSpec.describe Cart do
  describe 'Instance Methods' do
    before :each do
      ...
      @discount_1 = @ogre.discounts.create(percentage: 20, number_needed: 1, merchant_id: @ogre.merchant.id)
    ...
    it '.grand_total' do
      expect(@cart.grand_total).to eq(116.0)
    end
    ...
    it ".discount_subtotal_of()" do
      expect(@cart.discount_subtotal_of(@ogre.id)).to eq(16.0)
    end
  end
end
